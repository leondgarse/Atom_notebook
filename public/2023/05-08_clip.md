...
## Train test using train_func
  ...
  **Precition**
  ...
  sim = model.run_prediction(aa, ['cat', 'dog', 'diagram'])
  ax = plot_func.show_images_texts_similarity(images, ['cat', 'dog', 'diagram'], sim)
  ax.get_figure().savefig("aa.png")
  ```
  ```py
  ...
  data_path = "datasets/coco_dog_cat/train2017/images"
  images = np.concatenate([test_images.cat(), test_images.dog(), test_images.dog_cat()])
  sim = model.run_prediction(image_model.preprocess_input(images), ['cat', 'dog', 'diagram'])
  ax = plot_func.show_images_texts_similarity(images, ['cat', 'dog', 'diagram'], sim)
  ax.get_figure().savefig("aa.png")
  ```
  **Show on skimages**
