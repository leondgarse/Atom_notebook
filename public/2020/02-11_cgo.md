...
## ncnn arm project
  ...
  - **Build**
    ...
    **Android run**
    ```sh
    AG test/test_faceModel.cpp faceModel/faceModel.cpp ./ncnn/lib/libncnn_arm64.a -IfaceModel -Incnn/include -lomp -landroid -llog
...
## Benchmark
  ...
  AG benchncnn.cpp ../src/datareader.cpp install/lib/libncnn_arm64.a -I../src -Iinstall/include/ncnn/ -lomp -llog -landroid -o benchncnn
