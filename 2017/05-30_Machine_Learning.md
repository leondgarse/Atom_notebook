...
# 目录
  ...
  - [机器学习基础概念](#机器学习基础概念)
  	- [关键术语](#关键术语)
  	- [机器学习的主要任务](#机器学习的主要任务)
  	- [用于执行分类、回归、聚类和密度估计的机器学习算法](#用于执行分类回归聚类和密度估计的机器学习算法)
  	- [选择合适的算法](#选择合适的算法)
  	- [开发机器学习应用程序的步骤](#开发机器学习应用程序的步骤)
  	- [原数据链接](#原数据链接)
  - [k-近邻算法 kNN](#k-近邻算法-knn)
  	- [介绍](#介绍)
  	- [python实现kNN分类函数](#python实现knn分类函数)
  	- [简单测试用例](#简单测试用例)
  ...
  - [基于Logistic回归和Sigmoid函数的分类](#基于logistic回归和sigmoid函数的分类)
  	...
  	- [python实现梯度上升算法与绘制最佳拟合直线](#python实现梯度上升算法与绘制最佳拟合直线)
  	- [训练算法：随机梯度上升](#训练算法随机梯度上升)
  	- [参数收敛](#参数收敛)
  	- [改进的随机梯度上升算法](#改进的随机梯度上升算法)
